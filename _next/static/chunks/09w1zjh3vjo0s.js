...
📣 CTA (Call To Action):
${e.cta}`,$=`${e.hook} ${e.visuals} ${e.cameraMovement} Lighting: ${e.lighting}. Background: ${e.background}. Mood: ${e.mood}. ${e.cta}`.trim();(0,r.useEffect)(()=>()=>{u&&URL.revokeObjectURL(u)},[u]);let C=(0,r.useCallback)(()=>{w.current&&(clearInterval(w.current),w.current=null),k.current&&(clearInterval(k.current),k.current=null)},[]);(0,r.useEffect)(()=>()=>C(),[C]);let _=(0,r.useCallback)(async e=>{try{let t=await fetch("/api/veo/poll",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operationName:e})}),r=await t.json();if(!t.ok)throw Error(r.error??"Poll failed");if(r.done)if(C(),r.videoUri){g(r.videoUri);try{let e=await fetch("/api/veo/download",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({videoUri:r.videoUri})}),t=await e.blob(),a=URL.createObjectURL(t);b(a)}catch{}m("done")}else y("Video generation completed but no video was returned."),m("error")}catch(e){C(),y(e instanceof Error?e.message:"Poll failed"),m("error")}},[C]),T=async()=>{m("generating"),y(null),g(null),b(null),p(null),j(0);try{let e=await fetch("/api/veo/generate",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:$})}),t=await e.json();if(!e.ok)throw Error(t.error??"Failed to start generation");let r=t.operationName;p(r),k.current=setInterval(()=>j(e=>e+1),1e3),w.current=setInterval(()=>_(r),5e3)}catch(e){y(e instanceof Error?e.message:"Failed to start video generation"),m("error")}},A=e=>`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`;return(0,t.jsxs)("div",{className:"bg-white rounded-2xl border border-gray-100 shadow-sm card-hover overflow-hidden",children:[(0,t.jsx)("button",{onClick:()=>d(!l),className:"w-full text-left",children:(0,t.jsxs)("div",{className:"px-6 py-5 flex items-center gap-4",children:[(0,t.jsx)("div",{className:"w-9 h-9 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold text-sm flex-shrink-0",children:a+1}),(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 flex-wrap",children:[(0,t.jsx)("span",{className:`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${N.bg} ${N.text} border ${N.border}`,children:e.type}),(0,t.jsx)("span",{className:"text-gray-400 text-xs",children:"Video Ad"}),"done"===c&&(0,t.jsxs)("span",{className:"inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-200",children:[(0,t.jsx)("span",{className:"w-1.5 h-1.5 bg-emerald-500 rounded-full"}),"Video ready"]}),"generating"===c&&(0,t.jsxs)("span",{className:"inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700 border border-indigo-200",children:[(0,t.jsx)("span",{className:"w-3 h-3 rounded-full border border-indigo-400 border-t-transparent animate-spin"}),"Generating… ",A(v)]})]}),!l&&(0,t.jsx)("p",{className:"text-gray-600 text-sm mt-1 truncate",children:e.hook})]}),(0,t.jsxs)("div",{className:"flex items-center gap-3 flex-shrink-0",children:[(0,t.jsx)(s,{text:S,label:"Copy All"}),(0,t.jsx)("div",{className:`transition-transform duration-200 ${l?"rotate-180":""}`,children:(0,t.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"#9ca3af",strokeWidth:"2",children:(0,t.jsx)("polyline",{points:"6 9 12 15 18 9"})})})]})]})}),l&&(0,t.jsxs)("div",{className:"border-t border-gray-50",children:["done"===c&&(0,t.jsxs)("div",{className:"px-6 pt-5",children:[(0,t.jsx)("div",{className:"rounded-xl overflow-hidden bg-black aspect-[9/16] max-w-xs mx-auto",children:u?(0,t.jsx)("video",{src:u,controls:!0,autoPlay:!0,loop:!0,playsInline:!0,className:"w-full h-full object-cover"}):(0,t.jsx)("div",{className:"w-full h-full flex items-center justify-center text-white text-sm opacity-60",children:"Loading video…"})}),(0,t.jsxs)("div",{className:"flex items-center justify-center gap-3 mt-3 mb-1",children:[u&&(0,t.jsxs)("a",{href:u,download:`ad-${e.type.toLowerCase().replace(/\s+/g,"-")}.mp4`,className:"flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-all",children:[(0,t.jsxs)("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[(0,t.jsx)("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),(0,t.jsx)("polyline",{points:"7 10 12 15 17 10"}),(0,t.jsx)("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),"Download MP4"]}),(0,t.jsxs)("button",{onClick:T,className:"flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-indigo-600 bg-indigo-50 border border-indigo-200 rounded-lg hover:bg-indigo-100 transition-all",children:[(0,t.jsxs)("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[(0,t.jsx)("polyline",{points:"23 4 23 10 17 10"}),(0,t.jsx)("polyline",{points:"1 20 1 14 7 14"}),(0,t.jsx)("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),"Regenerate"]})]})]}),"error"===c&&f&&(0,t.jsxs)("div",{className:"mx-6 mt-5 bg-red-50 border border-red-200 rounded-xl p-4 text-sm text-red-700 flex items-start gap-2",children:[(0,t.jsxs)("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:"flex-shrink-0 mt-0.5",children:[(0,t.jsx)("circle",{cx:"12",cy:"12",r:"10"}),(0,t.jsx)("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),(0,t.jsx)("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})]}),(0,t.jsx)("span",{children:f})]}),"generating"===c&&(0,t.jsxs)("div",{className:"mx-6 mt-5 bg-indigo-50 border border-indigo-100 rounded-xl p-5",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-8 h-8 rounded-full border-2 border-indigo-200 border-t-indigo-600 animate-spin flex-shrink-0"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"text-sm font-semibold text-indigo-900",children:"Generating video with Veo 3…"}),(0,t.jsxs)("p",{className:"text-xs text-indigo-600 mt-0.5",children:["This takes about 1–2 minutes · ",A(v)," elapsed"]})]})]}),(0,t.jsx)("div",{className:"mt-3 h-1.5 bg-indigo-100 rounded-full overflow-hidden",children:(0,t.jsx)("div",{className:"h-full bg-indigo-500 rounded-full transition-all duration-1000",style:{width:`${Math.min(v/90*100,95)}%`}})})]}),(0,t.jsx)("div",{className:"px-6 py-5 space-y-5",children:n.map(({key:r,label:a,emoji:i})=>(0,t.jsxs)("div",{className:"group",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,t.jsxs)("span",{className:"text-xs font-semibold text-gray-500 uppercase tracking-wide flex items-center gap-1.5",children:[(0,t.jsx)("span",{children:i}),a]}),(0,t.jsx)(s,{text:String(e[r]),label:"Copy",className:"opacity-0 group-hover:opacity-100 transition-opacity"})]}),(0,t.jsx)("p",{className:"text-gray-800 text-sm leading-relaxed bg-gray-50 rounded-xl p-3.5",children:String(e[r])})]},r))}),(0,t.jsxs)("div",{className:"px-6 py-4 bg-indigo-50 border-t border-indigo-100 flex items-center justify-between gap-3",children:[(0,t.jsx)(s,{text:S,label:"Copy Full Prompt"}),(0,t.jsx)("button",{onClick:T,disabled:"generating"===c,className:"flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-sm",children:"generating"===c?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{className:"w-3.5 h-3.5 rounded-full border-2 border-white border-t-transparent animate-spin"}),"Generating…"]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:(0,t.jsx)("polygon",{points:"5 3 19 12 5 21 5 3"})}),"Generate Video"]})})]})]})]})}let l={"Product in Hand":{bg:"bg-teal-50",text:"text-teal-700",border:"border-teal-200"},"Before-After":{bg:"bg-blue-50",text:"text-blue-700",border:"border-blue-200"},"Clean Brand":{bg:"bg-slate-50",text:"text-slate-700",border:"border-slate-200"},Lifestyle:{bg:"bg-amber-50",text:"text-amber-700",border:"border-amber-200"},Testimonial:{bg:"bg-emerald-50",text:"text-emerald-700",border:"border-emerald-200"}},d=[{key:"layout",label:"Layout",emoji:"📐"},{key:"backgroundStyle",label:"Background Style",emoji:"🖼️"},{key:"colorPalette",label:"Color Palette",emoji:"🎨"},{key:"headline",label:"Headline",emoji:"✍️"},{key:"subheadline",label:"Subheadline",emoji:"💬"},{key:"badge",label:"Badge",emoji:"🏷️"},{key:"moodAndStyle",label:"Mood & Style",emoji:"✨"},{key:"aiPrompt",label:"AI Image Prompt",emoji:"🤖",highlight:!0}];function c({ad:e,index:a}){let[i,n]=(0,r.useState)(!1),o=function(e){for(let t of Object.keys(l))if(e.toLowerCase().includes(t.toLowerCase()))return l[t];return{bg:"bg-violet-50",text:"text-violet-700",border:"border-violet-200"}}(e.type),m=`IMAGE AD PROMPT — ${e.type.toUpperCase()}
...
${e.aiPrompt}`;return(0,t.jsxs)("div",{className:"bg-white rounded-2xl border border-gray-100 shadow-sm card-hover overflow-hidden",children:[(0,t.jsx)("button",{onClick:()=>n(!i),className:"w-full text-left",children:(0,t.jsxs)("div",{className:"px-6 py-5 flex items-center gap-4",children:[(0,t.jsx)("div",{className:"w-9 h-9 rounded-xl bg-violet-50 flex items-center justify-center text-violet-600 font-bold text-sm flex-shrink-0",children:a+1}),(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 flex-wrap",children:[(0,t.jsx)("span",{className:`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${o.bg} ${o.text} border ${o.border}`,children:e.type}),(0,t.jsx)("span",{className:"text-gray-400 text-xs",children:"Image Ad"})]}),!i&&(0,t.jsx)("p",{className:"text-gray-800 text-sm mt-1 font-medium truncate",children:e.headline})]}),(0,t.jsxs)("div",{className:"flex items-center gap-3 flex-shrink-0",children:[(0,t.jsx)(s,{text:e.aiPrompt,label:"Copy AI Prompt"}),(0,t.jsx)("div",{className:`transition-transform duration-200 ${i?"rotate-180":""}`,children:(0,t.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"#9ca3af",strokeWidth:"2",children:(0,t.jsx)("polyline",{points:"6 9 12 15 18 9"})})})]})]})}),!i&&(0,t.jsxs)("div",{className:"px-6 pb-4 flex flex-wrap gap-2",children:[e.badge&&(0,t.jsxs)("span",{className:"inline-flex items-center gap-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-md",children:["🏷️ ",e.badge]}),e.colorPalette&&(0,t.jsxs)("span",{className:"text-xs text-gray-400 bg-gray-50 px-2 py-0.5 rounded-md",children:["🎨 ",e.colorPalette.substring(0,40),"..."]})]}),i&&(0,t.jsxs)("div",{className:"border-t border-gray-50",children:[(0,t.jsx)("div",{className:"px-6 py-5 space-y-5",children:d.map(({key:r,label:a,emoji:i,highlight:n})=>(0,t.jsxs)("div",{className:"group",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,t.jsxs)("span",{className:"text-xs font-semibold text-gray-500 uppercase tracking-wide flex items-center gap-1.5",children:[(0,t.jsx)("span",{children:i}),a]}),(0,t.jsx)(s,{text:String(e[r]),label:"Copy",className:"opacity-0 group-hover:opacity-100 transition-opacity"})]}),(0,t.jsx)("div",{className:`rounded-xl p-3.5 ${n?"bg-violet-50 border border-violet-100":"bg-gray-50"}`,children:"badge"===r?(0,t.jsx)("span",{className:"inline-flex items-center bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-md",children:String(e[r])}):(0,t.jsx)("p",{className:`text-sm leading-relaxed ${n?"text-violet-800 font-mono":"text-gray-800"}`,children:String(e[r])})})]},r))}),(0,t.jsxs)("div",{className:"px-6 py-4 bg-violet-50 border-t border-violet-100 flex items-center justify-between",children:[(0,t.jsx)("span",{className:"text-xs text-violet-600 font-medium",children:"Ready for Midjourney / DALL-E"}),(0,t.jsx)(s,{text:m,label:"Copy Full Prompt"})]})]})]})}function m({onGenerate:e,loading:a}){let[s,i]=(0,r.useState)({productName:"",productDescription:"",customerReviews:"",targetAudience:"",price:""}),n=s.productName.trim()&&s.productDescription.trim()&&!a,o=e=>t=>i(r=>({...r,[e]:t.target.value}));return(0,t.jsxs)("div",{className:"bg-white rounded-2xl border border-gray-100 shadow-sm p-8",children:[(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4",children:[(0,t.jsxs)("div",{className:"sm:col-span-2",children:[(0,t.jsxs)("label",{className:"block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2",children:["Product Name ",(0,t.jsx)("span",{className:"text-red-400",children:"*"})]}),(0,t.jsx)("input",{type:"text",placeholder:"e.g. Posture Corrector Pro",value:s.productName,onChange:o("productName"),className:"w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("label",{className:"block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2",children:["Price ",(0,t.jsx)("span",{className:"text-gray-400 font-normal",children:"(optional)"})]}),(0,t.jsx)("input",{type:"text",placeholder:"e.g. $39",value:s.price,onChange:o("price"),className:"w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"})]})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("label",{className:"block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2",children:["Product Description ",(0,t.jsx)("span",{className:"text-red-400",children:"*"})]}),(0,t.jsx)("textarea",{rows:3,placeholder:"What does it do, how does it work, what makes it different?",value:s.productDescription,onChange:o("productDescription"),className:"w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all resize-none"})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("label",{className:"block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2",children:["Customer Reviews"," ",(0,t.jsx)("span",{className:"text-gray-400 font-normal",children:"(optional — paste real reviews for best results)"})]}),(0,t.jsx)("textarea",{rows:4,placeholder:`Paste 3–10 customer reviews here. The more specific, the better.

Example:
"I tried everything for my back pain. This actually worked within 3 days." — Sarah K.
"So easy to use and I already notice a difference." — Mike T.`,value:s.customerReviews,onChange:o("customerReviews"),className:"w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all resize-none"})]}),(0,t.jsxs)("div",{children:[(0,t.jsxs)("label",{className:"block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2",children:["Target Audience ",(0,t.jsx)("span",{className:"text-gray-400 font-normal",children:"(optional)"})]}),(0,t.jsx)("input",{type:"text",placeholder:"e.g. Women 30–55 with chronic back pain, office workers",value:s.targetAudience,onChange:o("targetAudience"),className:"w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"})]}),(0,t.jsx)("button",{onClick:()=>e(s),disabled:!n,className:"w-full py-3.5 px-6 rounded-xl font-semibold text-sm text-white bg-black hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2",children:a?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{className:"w-4 h-4 rounded-full border-2 border-white border-t-transparent animate-spin"}),"Writing landing page…"]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[(0,t.jsx)("path",{d:"M12 20h9"}),(0,t.jsx)("path",{d:"M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"})]}),"Generate Landing Page"]})})]}),(0,t.jsx)("div",{className:"mt-5 flex flex-wrap gap-x-5 gap-y-1.5 text-xs text-gray-400",children:["Hero section","Transformation story","4 value props","How it works","Social proof","Objection handling","Final close"].map(e=>(0,t.jsxs)("span",{className:"flex items-center gap-1",children:[(0,t.jsx)("span",{className:"w-1 h-1 rounded-full bg-gray-300"}),e]},e))})]})}function h(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function p(e){let{hero:t,coreMassDesire:r,transformation:a,valueProps:s,testimonials:i,finalClose:n}=e,o=["⚡","🔒","✓","🎯"],l=r.painPoints.map(e=>`
      <li class="pain-item">
        <span class="pain-icon">✗</span>
        <span>${h(e)}</span>
      </li>`).join(""),d=s.map((e,t)=>`
      <li class="benefit-card">
        <div class="benefit-icon">${o[t]??"✓"}</div>
        <h3 class="benefit-heading">${h(e.headline)}</h3>
        <p class="benefit-body">${h(e.explanation)}</p>
        ${e.betterThan?`<p class="benefit-vs">${h(e.betterThan)}</p>`:""}
      </li>`).join(""),c=i.map(e=>`
      <li class="testimonial-card">
        <div class="testimonial-stars">${function(e=5){return"★".repeat(Math.min(5,Math.max(1,e)))}(5)}</div>
        <blockquote class="testimonial-quote">${h(e.story)}</blockquote>
        <p class="testimonial-result">✓ ${h(e.result)}</p>
        <footer class="testimonial-footer">
          <div class="testimonial-avatar">${h(e.name.split(/[\s,]+/).slice(0,2).map(e=>e[0]?.toUpperCase()??"").join(""))}</div>
          <div>
            <cite class="testimonial-name">${h(e.name)}</cite>
            <span class="testimonial-timeframe">${h(e.timeframe)}</span>
          </div>
        </footer>
      </li>`).join("");return a.paragraphs.map(e=>`<p>${h(e)}</p>`).join(""),`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>${h(t.headline)} — Landing Page Preview</title>
<style>
...
@media (min-width: 960px) { .benefits__grid { grid-template-columns: repeat(${Math.min(s.length,3)}, 1fr); } }
.benefit-card {
...
<section class="hero" id="hero">
  ...
  <div class="hero__content container">
    <div class="hero__badge">
      ...
      <span>${h(t.trustBadge)}</span>
    </div>
    <h1 class="hero__heading">${h(t.headline)}</h1>
    <p class="hero__sub">${h(t.subheadline)}</p>
    <div class="hero__cta-group">
      <a href="#final-cta" class="btn btn--primary btn--lg">${h(t.cta)}</a>
    </div>
    <p class="hero__trust" style="margin-top:1rem;">🔒 30-Day Risk-Free Guarantee &nbsp;\xb7&nbsp; Free Shipping &nbsp;\xb7&nbsp; Secure Checkout</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="solution__grid">
      ...
      <div class="solution__copy">
        ...
        <h2 class="section-heading">${h(s[0]?.headline??"Built for Real People")}</h2>
        <div class="prose">
          <p>${h(a.paragraphs[1]??"")}</p>
        </div>
        <div style="margin-top:0.5rem;">
          <a href="#final-cta" class="btn btn--secondary">${h(a.cta)}</a>
        </div>
      </div>
    </div>
  </div>
...
<section class="final-cta" id="final-cta">
  <div class="final-cta__inner">
    <h2 class="final-cta__heading">${h(n.headline)}</h2>
    ${n.paragraphs.map(e=>`<p class="final-cta__body">${h(e)}</p>`).join("")}
    <div class="final-cta__actions">
      <a href="#" class="btn btn--primary btn--lg">${h(n.cta)}</a>
      <p class="trust-line">🔒 30-Day Risk-Free Guarantee &nbsp;\xb7&nbsp; 🚚 Free Tracked Shipping &nbsp;\xb7&nbsp; ✓ Secure Checkout &nbsp;\xb7&nbsp; 💳 No Hidden Fees</p>
    </div>
  </div>
</section>
...
<div class="sticky-bar" id="sticky-bar">
  <span class="sticky-bar__text">${h(t.headline.length>48?t.headline.slice(0,48)+"…":t.headline)}</span>
  <a href="#final-cta" class="btn btn--primary" style="padding:0.6875rem 1.5rem;font-size:0.9375rem;box-shadow:none;">${h(t.cta)}</a>
</div>
...
</html>`}function x({id:e,label:a,badge:i,color:n,children:o,copyText:l}){let[d,c]=(0,r.useState)(!0);return(0,t.jsxs)("div",{className:"bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden",id:e,children:[(0,t.jsxs)("button",{onClick:()=>c(!d),className:"w-full text-left px-6 py-4 flex items-center gap-3",children:[(0,t.jsx)("span",{className:`text-xs font-bold px-2.5 py-0.5 rounded-full ${n}`,children:i||a}),(0,t.jsx)("span",{className:"flex-1 text-sm font-semibold text-gray-700",children:a}),(0,t.jsx)(s,{text:l,label:"Copy Section"}),(0,t.jsx)("div",{className:`transition-transform duration-200 ml-1 ${d?"rotate-180":""}`,children:(0,t.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"#9ca3af",strokeWidth:"2",children:(0,t.jsx)("polyline",{points:"6 9 12 15 18 9"})})})]}),d&&(0,t.jsx)("div",{className:"border-t border-gray-50 px-6 pb-6 pt-5",children:o})]})}function g({label:e,value:r}){return(0,t.jsxs)("div",{className:"group",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1",children:[(0,t.jsx)("span",{className:"text-[11px] font-semibold text-gray-400 uppercase tracking-widest",children:e}),(0,t.jsx)(s,{text:r,label:"Copy",className:"opacity-0 group-hover:opacity-100 transition-opacity"})]}),(0,t.jsx)("p",{className:"text-sm text-gray-800 leading-relaxed bg-gray-50 rounded-xl px-4 py-3",children:r})]})}function u({label:e,items:r}){let a=r.join("\n");return(0,t.jsxs)("div",{className:"group",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-1",children:[(0,t.jsx)("span",{className:"text-[11px] font-semibold text-gray-400 uppercase tracking-widest",children:e}),(0,t.jsx)(s,{text:a,label:"Copy",className:"opacity-0 group-hover:opacity-100 transition-opacity"})]}),(0,t.jsx)("ul",{className:"space-y-2",children:r.map((e,r)=>(0,t.jsxs)("li",{className:"text-sm text-gray-800 leading-relaxed bg-gray-50 rounded-xl px-4 py-2.5 flex gap-2",children:[(0,t.jsxs)("span",{className:"text-gray-400 flex-shrink-0",children:[r+1,"."]}),(0,t.jsx)("span",{children:e})]},r))})]})}function b({landing:e,onRegenerate:r}){let a,i=((a=[]).push(`=== CORE MASS DESIRE ===
...
CTA: ${e.hero.cta}`),a.push(`=== RESULTS / TRANSFORMATION ===
${e.transformation.paragraphs.join("\n\n")}

CTA: ${e.transformation.cta}`),a.push(`=== VALUE PROPOSITIONS ===
...
Better than alternatives? ${e.objections.betterThanAlternatives}`),a.push(`=== FINAL CLOSE ===
${e.finalClose.headline}

${e.finalClose.paragraphs.join("\n\n")}

CTA: ${e.finalClose.cta}`),a.join("\n\n---\n\n"));return(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-900",children:"Landing Page Copy"}),(0,t.jsx)("p",{className:"text-gray-500 text-sm mt-1",children:"7 sections · Ready to use"})]}),(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-2",children:[(0,t.jsxs)("button",{onClick:()=>{let t=new Blob([p(e)],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(t);window.open(r,"_blank"),setTimeout(()=>URL.revokeObjectURL(r),6e4)},className:"flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-all",children:[(0,t.jsxs)("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[(0,t.jsx)("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),(0,t.jsx)("circle",{cx:"12",cy:"12",r:"3"})]}),"Preview Page"]}),(0,t.jsxs)("button",{onClick:()=>{let t=new Blob([p(e)],{type:"text/html;charset=utf-8"}),r=URL.createObjectURL(t),a=document.createElement("a");a.href=r,a.download="landing-page-preview.html",a.click(),URL.revokeObjectURL(r)},className:"flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all",children:[(0,t.jsxs)("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[(0,t.jsx)("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),(0,t.jsx)("polyline",{points:"7 10 12 15 17 10"}),(0,t.jsx)("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),"Download HTML"]}),(0,t.jsx)(s,{text:i,label:"Copy All"}),(0,t.jsxs)("button",{onClick:r,className:"flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all",children:[(0,t.jsxs)("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[(0,t.jsx)("polyline",{points:"23 4 23 10 17 10"}),(0,t.jsx)("polyline",{points:"1 20 1 14 7 14"}),(0,t.jsx)("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),"Regenerate"]})]})]}),(0,t.jsxs)("div",{className:"space-y-4",children:[(0,t.jsx)(x,{id:"lp-desire",label:"Core Mass Desire",badge:"Strategy",color:"bg-purple-50 text-purple-700",copyText:function(e,t){let r=[`=== ${e.toUpperCase()} ===`,""];for(let[e,a]of Object.entries(t))Array.isArray(a)?(r.push(`${e.toUpperCase()}:`),a.forEach((e,t)=>r.push(`  ${t+1}. ${e}`))):"string"==typeof a&&(r.push(`${e.toUpperCase()}:`),r.push(`  ${a}`)),r.push("");return r.join("\n")}("Core Mass Desire",{Statement:e.coreMassDesire.statement,"Pain Points":e.coreMassDesire.painPoints,"Desired Outcomes":e.coreMassDesire.desiredOutcomes,"Proof Elements":e.coreMassDesire.proofElements}),children:(0,t.jsxs)("div",{className:"space-y-5",children:[(0,t.jsx)(g,{label:"Core Desire Statement",value:e.coreMassDesire.statement}),(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[(0,t.jsx)(u,{label:"Pain Points",items:e.coreMassDesire.painPoints}),(0,t.jsx)(u,{label:"Desired Outcomes",items:e.coreMassDesire.desiredOutcomes}),(0,t.jsx)(u,{label:"Proof Elements",items:e.coreMassDesire.proofElements})]})]})}),(0,t.jsx)(x,{id:"lp-hero",label:"Hero Section",badge:"1",color:"bg-blue-50 text-blue-700",copyText:`${e.hero.trustBadge}
...
CTA: ${e.hero.cta}`,children:(0,t.jsxs)("div",{className:"space-y-4",children:[(0,t.jsx)(g,{label:"Trust Badge",value:e.hero.trustBadge}),(0,t.jsx)(g,{label:"Headline",value:e.hero.headline}),(0,t.jsx)(g,{label:"Subheadline",value:e.hero.subheadline}),(0,t.jsx)(u,{label:"Benefit Bullets",items:e.hero.bullets}),(0,t.jsx)(g,{label:"CTA",value:e.hero.cta})]})}),(0,t.jsx)(x,{id:"lp-transformation",label:"Results / Transformation",badge:"2",color:"bg-emerald-50 text-emerald-700",copyText:`${e.transformation.paragraphs.join("\n\n")}

CTA: ${e.transformation.cta}`,children:(0,t.jsxs)("div",{className:"space-y-4",children:[e.transformation.paragraphs.map((e,r)=>(0,t.jsx)(g,{label:0===r?"Before State":1===r?"The Shift":"After State",value:e},r)),(0,t.jsx)(g,{label:"CTA",value:e.transformation.cta})]})}),(0,t.jsx)(x,{id:"lp-valueprops",label:"Value Propositions",badge:"3",color:"bg-orange-50 text-orange-700",copyText:e.valueProps.map(e=>`${e.headline}
${e.explanation}
${e.betterThan}`).join("\n\n---\n\n"),children:(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:e.valueProps.map((e,r)=>(0,t.jsxs)("div",{className:"bg-gray-50 rounded-xl p-4 group relative",children:[(0,t.jsx)("div",{className:"absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity",children:(0,t.jsx)(s,{text:`${e.headline}
${e.explanation}
${e.betterThan}`,label:"Copy"})}),(0,t.jsx)("p",{className:"font-semibold text-gray-900 text-sm mb-2",children:e.headline}),(0,t.jsx)("p",{className:"text-gray-600 text-sm leading-relaxed mb-3",children:e.explanation}),(0,t.jsx)("p",{className:"text-xs text-gray-500 italic border-t border-gray-200 pt-2.5",children:e.betterThan})]},r))})}),(0,t.jsx)(x,{id:"lp-howitworks",label:"How It Works",badge:"4",color:"bg-indigo-50 text-indigo-700",copyText:e.howItWorks.map(e=>`Step ${e.step}: ${e.name}
${e.explanation}
Visual: ${e.visualDirection}`).join("\n\n"),children:(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:e.howItWorks.map(e=>(0,t.jsxs)("div",{className:"bg-gray-50 rounded-xl p-4 group relative",children:[(0,t.jsx)("div",{className:"absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity",children:(0,t.jsx)(s,{text:`Step ${e.step}: ${e.name}
${e.explanation}
Visual: ${e.visualDirection}`,label:"Copy"})}),(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-2",children:[(0,t.jsx)("span",{className:"w-6 h-6 rounded-full bg-indigo-600 text-white text-xs font-bold flex items-center justify-center flex-shrink-0",children:e.step}),(0,t.jsx)("span",{className:"font-semibold text-gray-900 text-sm",children:e.name})]}),(0,t.jsx)("p",{className:"text-gray-600 text-sm leading-relaxed mb-2",children:e.explanation}),(0,t.jsxs)("p",{className:"text-xs text-gray-400 flex items-start gap-1",children:[(0,t.jsxs)("svg",{width:"11",height:"11",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:"flex-shrink-0 mt-0.5",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),(0,t.jsx)("polyline",{points:"21 15 16 10 5 21"})]}),e.visualDirection]})]},e.step))})}),(0,t.jsx)(x,{id:"lp-proof",label:"Social Proof",badge:"5",color:"bg-yellow-50 text-yellow-700",copyText:e.testimonials.map(e=>`"${e.story}"

Result: ${e.result}
Timeframe: ${e.timeframe}
— ${e.name}`).join("\n\n---\n\n"),children:(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:e.testimonials.map((e,r)=>(0,t.jsxs)("div",{className:"bg-gray-50 rounded-xl p-4 group relative",children:[(0,t.jsx)("div",{className:"absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity",children:(0,t.jsx)(s,{text:`"${e.story}"

Result: ${e.result}
Timeframe: ${e.timeframe}
— ${e.name}`,label:"Copy"})}),(0,t.jsxs)("p",{className:"text-gray-700 text-sm leading-relaxed italic mb-3",children:['"',e.story,'"']}),(0,t.jsx)("p",{className:"text-xs font-semibold text-emerald-700 bg-emerald-50 rounded-lg px-2.5 py-1 inline-block mb-2",children:e.result}),(0,t.jsxs)("div",{className:"flex items-center justify-between mt-2",children:[(0,t.jsxs)("span",{className:"text-xs font-medium text-gray-600",children:["— ",e.name]}),(0,t.jsx)("span",{className:"text-xs text-gray-400",children:e.timeframe})]})]},r))})}),(0,t.jsx)(x,{id:"lp-objections",label:"Objection Handling",badge:"6",color:"bg-red-50 text-red-700",copyText:`Does it work?
